...
If startup recovery cannot load after a page reload, the session shows the loading error and **Retry**. The saved first message continues holding later input until recovery loads and confirms its delivery state.
